...
# if defined(ENABLE_SUPERACAN) || defined(NEEDS_SUPERACAN)
#   define HAS_SUPERACAN 1
# else
#   define HAS_SUPERACAN 0
# endif /* ENABLE_SUPERACAN || NEEDS_SUPERACAN */
...
# endif /* ENABLE_SELFTEST || NEEDS_SELFTEST */
...
#   if !defined(OPTION_CRDB_MULTIMATCH_CART)
#     define OPTION_CRDB_MULTIMATCH_CART (CRDBID_USE_ID32A|CRDBID_USE_ID32B)
#   elif (!((OPTION_CRDB_MULTIMATCH_CART) & CRDBID_USE_ID32A) && !((OPTION_CRDB_MULTIMATCH_CART) & CRDBID_USE_ID32B))
#     undef  OPTION_CRDB_MULTIMATCH_CART
#     define OPTION_CRDB_MULTIMATCH_CART (CRDBID_USE_ID32A|CRDBID_USE_ID32B)
#   endif

#   if !defined(OPTION_CRDB_MULTIMATCH_DB)
#     define OPTION_CRDB_MULTIMATCH_DB (CRDBID_USE_ID32B)
#   elif (!((OPTION_CRDB_MULTIMATCH_DB) & CRDBID_USE_ID32A) && !((OPTION_CRDB_MULTIMATCH_DB) & CRDBID_USE_ID32B))
#     undef  OPTION_CRDB_MULTIMATCH_DB
#     define OPTION_CRDB_MULTIMATCH_DB (CRDBID_USE_ID32B)
#   endif

#   if !defined(OPTION_CRDB_MULTIMATCH_METHOD)
#     define OPTION_CRDB_MULTIMATCH_METHOD CRDBID_MATCH_ANY
#   elif ISEMPTY(OPTION_CRDB_MULTIMATCH_METHOD)
#     undef  OPTION_CRDB_MULTIMATCH_METHOD
#     define OPTION_CRDB_MULTIMATCH_METHOD CRDBID_MATCH_ANY
#   endif
# endif /* ENABLE_NES */
