...
AVRdude:
Please comment #define REMOVE_CMD_SPI_MULTI when using AVRdude.
...
#if !defined(REMOVE_MONITOR) && (defined(_MEGA_BOARD_) || defined(_BOARD_AMBER128_) || defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__) || defined(__AVR_ATmega2561__) || defined(__AVR_ATmega1284P__) || defined(ENABLE_MONITOR))
...
//************************************************************************
#if !defined(REMOVE_BOOTLOADER_LED) || defined(ENABLE_ONBOARD_ATMEGA)
...
#elif defined(__AVR_ATmega8__) || defined(__AVR_ATmega16__) || defined(__AVR_ATmega32__) || defined(__AVR_ATmega8515__) || defined(__AVR_ATmega8535__)
...
#elif defined(__AVR_ATmega64__) || defined(__AVR_ATmega128__) || defined(__AVR_ATmega162__) || defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__) || defined(__AVR_ATmega2561__)
  ...
  if (boot_state==1)
  {
    ...
    while (!isLeave)
    {
      ...
      case CMD_SPI_MULTI:
        ...
        // msgBuffer[5] = boot_lock_fuse_bits_get(GET_LOW_FUSE_BITS);
        // msgBuffer[5] = boot_lock_fuse_bits_get(GET_HIGH_FUSE_BITS);
        // msgBuffer[5] = boot_lock_fuse_bits_get(GET_EXTENDED_FUSE_BITS);
        ...
        {
          msgBuffer[5] = 0; // for all others command are not implemented, return dummy value for AVRDUDE happy <Worapoht>
        }
      ...
      case CMD_PROGRAM_LOCK_ISP:
        ...
        msgBuffer[4] = (~msgBuffer[4]) & 0x3C; // mask BLBxx bits
        boot_lock_bits_set(msgBuffer[4]);  // and program it
        boot_spm_busy_wait();
